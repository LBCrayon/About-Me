...
import {
    ...
    SiAdobeillustrator,
    SiAdobephotoshop, SiAstro, SiCinema4D, SiCplusplus, SiCss3, SiDocker, SiDotnet, SiFigma, SiFirebase, SiFramer, SiGit,
    SiGithub,
    SiGooglechrome, SiGooglefonts,
    SiHtml5,
    SiIntellijidea, SiJavascript, SiJquery, SiKotlin, SiLua,
    SiMysql,
    SiNeovim, SiNextdotjs, SiPostgresql, SiPreact, SiReact, SiRedux, SiRust, SiScrumalliance, SiTypescript, SiVercel, SiWebstorm, SiZig
} from "react-icons/si";
